...
$sql = "select * from register where id= '".$_SESSION['rainbow_uid']."' and password='".md5($oldpassword )."'";
$q = $conn->query($sql);
if($q->num_rows>0)
{

$sql = "update register set  password = '".md5($newpassword)."' WHERE id = '".$_SESSION['rainbow_uid']."'";
$r = $conn->query($sql);
echo '<script type="text/javascript">window.location="change-password.php?act=1"; </script>';
}else
{
...
?>
               ...
               <div class="panel panel-success">
						...
						<form action="change-password.php" method="post" id="signupForm1" class="form-horizontal">
