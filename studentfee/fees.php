  ...
  <div class="form-group">
    ...
    <select  class="form-control" id="semesters" name="semesters" >
		<option value="" >Select Semester</option>
                                    <?php
									$sql = "select * from semesters where delete_status='0' order by semesters.semester_name asc";
									$q = $conn->query($sql);
									
									while($r = $q->fetch_assoc())
									{
									echo '<option value="'.$r['id'].'"  '.(($semesters==$r['semester_id'])?'selected="selected"':'').'>'.$r['semester_name'].'</option>';
									}
									?>
	</select>
  </div>
...
function mydatatable()
{
              ...
              $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Name/Contact</th><th>Fees</th><th>Balance</th><th>semesters</th><th>DOJ</th><th>Action</th></tr></thead><tbody></tbody></table>');
