...
<body class="m-4">
    ...
    <div class="d-flex justify-content-center mt-3">
        <form class="row g-3 w-50 mt-4" action="payment-request.php" method="POST">
            ...
            <div class="col-md-6">
                <label for="inputPurchasedOrderId4" class="form-label">Fee Order Id</label>
                <input type="PurchasedOrderId" class="form-control" id="inputPurchasedOrderId4" name="inputPurchasedOrderId4">
            </div>
            <div class="col-12">
                <label for="inputPurchasedOrderName" class="form-label">Fee Order Name</label>
